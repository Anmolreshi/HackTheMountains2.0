          ...
          <Hidden smDown>
            ...
            <span id="HTMNav">
              ...
              <Box display="flex" flexDirection="row" justifyContent="flex-end">
                ...
                <Box  p={1}>
                <a style={{textDecoration:'none',color:"#434040"}} target="_blank" rel = "noopener noreferrer" href="https://www.notion.so/28e8804176e14b3ba4b15309917eded1?v=147cb6a1ffa444139b74444bb581ea8a">
                 <Typography  className={classes.onhover} gutterBottom={true} variant="subtitle2">
                       <b>Schedule</b> {" "}
                  </Typography></a></Box>
