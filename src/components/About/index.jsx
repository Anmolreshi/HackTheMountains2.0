        ...
        <Container>
          <Grid container spacing={8}>
            <Grid item xs={12} sm={12} md={6} lg={6} className={classes.left}>
              <Box >
                <Typography variant="h5" style={{textAlign:'center'}} gutterBottom={true}><b>What's this all about?</b></Typography>
                <Typography variant="h6"> We are organizing an International Level Hackathon “HACK THE MOUNTAINS 2.O”  a 36 hour virtual Hackathon  by the First ever Tech community from Jammu and Kashmir “SUDAN’S TECH ” -  by the students and for the students.
<br/><br/>
<a target="_blank" href="https://sudans.tech/" rel="noopener noreferrer">
        SUDAN'S TECH</a>  is a Non profit Organization registered under government of india under section - 8 company rules which provides technical education to students. Our main focus is to provide technical education and make students industry ready.
            ...
            <Grid container spacing={8} item xs={12} sm={12} md={6} lg={6}>
              ...
              <Grid item xs={12} sm={12} md={12} lg={12} className={classes.rightdown}>
                <Box >
                  <Typography variant="h5"  style={{textAlign:'center'}} ><b>Want to ask us something?</b> </Typography>
      ...
      <Box >
                      <Typography  style={{textAlign:'center'}} variant="h5" gutterBottom={true}><b>What's this all about?</b></Typography>
                      <Typography variant="h6"><br/> We are organizing an International Level Hackathon “HACK THE MOUNTAINS 2.O”  a 36 hour virtual Hackathon  by the First ever Tech community from Jammu And Kashmir “SUDAN’S TECH ” -  by the students and for the students.
      <br/><br/>
      <a target="_blank" href="https://sudans.tech/" rel="noopener noreferrer">
        SUDAN'S TECH</a> is a Non profit Organization registered under government of India under section - 8 company rules which provides technical education to students. Our main focus is to provide technical education and make students industry ready.
                      </Typography>
      ...
      <Grid item xs={12} sm={12} style={{marginBottom:'10px',background: 'white', padding:'20px', borderRadius:'5px'}}>
                      <Box>
                        <Typography  style={{textAlign:'center'}} variant="h5" gutterBottom={true}><b>How do I signup?</b> </Typography>
      ...
      <Box >
                  <Typography   style={{textAlign:'center'}} variant="h5"><b>Want to ask us something?</b> </Typography>
                  <Typography variant="h6"><br/>
                 Feel free to reach out to us on our socials,
                 Twitter, LinkedIn, or if you need a quick help, raise a ticket for your query 
                 here.
